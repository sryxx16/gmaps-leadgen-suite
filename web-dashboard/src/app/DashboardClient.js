                    ...
                    {lead.phone ? (
                      <a 
                        ...
                        href={`https://wa.me/${lead.phone.replace(/\D/g, '').replace(/^0/, '62')}?text=${encodeURIComponent(
                          `Halo Kak, perkenalkan kami dari tim penyedia jasa website untuk UMKM 🙏\n\nIzin menghubungi ya Kak. Kami melihat profil bisnis *${lead.name}* di Google Maps dan melihat potensinya sangat bagus. Namun kami perhatikan saat ini *${lead.name}* sepertinya belum memiliki website resmi untuk menjangkau lebih banyak pelanggan dari mesin pencari.\n\nJika Kakak berkenan, kami bisa bantu buatkan website profesional namun terjangkau. Websitenya bisa menampilkan profil usaha, katalog layanan/produk, hingga tombol yang langsung terhubung ke WhatsApp Kakak.\n\nApakah boleh kami kirimkan beberapa contoh desainnya dulu sebagai gambaran? Dilihat-lihat dulu saja Kak, tidak ada paksaan atau komitmen kok 😊\n\nMohon maaf jika mengganggu waktunya. Terima kasih banyak Kak 🙏`
                        )}`} 
                        target="_blank" 
                        rel="noopener noreferrer"
                      >
